        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (role.FirstOrDefault() == UserRoles.CompanyOwner.ToString())
                        return RedirectToAction("Index", "Home", new { Area = "Company" });
                    else if (role.FirstOrDefault() == UserRoles.Vendor.ToString())
                        return RedirectToAction("Index", "Home", new { Area = "Vendor" });
                    else if (role.FirstOrDefault() == UserRoles.Customer.ToString())
